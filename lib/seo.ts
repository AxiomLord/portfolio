...
export const homepageDescription = `Portfolio of ${profile.name}, a senior agentic AI engineer building reliable LLM products, full-stack systems, and AI workflows with React, Node.js, Python, and AWS.`;
...
export const rootJsonLd = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      url: profile.url,
      name: profile.name,
      alternateName: [profile.handle, profile.url],
