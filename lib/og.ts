...
const STATIC_OG_INPUTS: Record<string, OgInput> = {
  ...
  "/home": {
    ...
    meta: ["NICHOLASLEE.DEV", "AGENTS", "LLMs", "AWS"],
  },
  "/home/experience": {
    template: "rail",
    kicker: "EXPERIENCE",
    title: "Experience",
    subtitle:
      "Agentic AI, conversational systems, analytics, and healthcare software.",
    meta: ["NICHOLASLEE.DEV", "FERMAT", "CAPITAL ONE", "DATACHAT"],
  },
  "/home/about": {
    template: "rail",
    kicker: "ABOUT",
    ...
    meta: ["NICHOLASLEE.DEV", "AI", "SYSTEMS", "PRODUCT"],
  },
  "/home/photography": {
    template: "rail",
    kicker: "PHOTOGRAPHY",
    ...
    meta: ["NICHOLASLEE.DEV", "PHOTOGRAPHY", "PANORAMAS"],
  },
  "/home/playground": {
    template: "rail",
    kicker: "PLAYGROUND",
    ...
    meta: ["NICHOLASLEE.DEV", "TYPOGRAPHY", "WEBGL2", "MOTION"],
  },
};
...
export function getOgImageMetadata(input: OgInput): OgImageMetadata[] {
  return [
    {
      id: "default",
      alt: `${input.title.trim()} · nicholaslee.dev`,
      size: OG_SIZE,
      contentType: "image/png",
    },
  ];
