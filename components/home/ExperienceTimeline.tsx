  ...
  return (
    ...
    >
      <header className="flex flex-col gap-3.75">
        ...
        >
          Agents, products, infrastructure.{" "}
          <span className="text-ink">Eight years, measurable outcomes.</span>
        </h1>
        <p
          className={cn(
            sans,
        ...
        >
          Every role here shows the product context, the systems behind it, and
          the outcome it was built to change. Hover a role to open the details.
        </p>
        <p
          className={cn(
            mono,
