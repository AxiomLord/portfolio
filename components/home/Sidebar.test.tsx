...
test("keeps sidebar status and timezone in profile configuration", () => {
  expect(profile.role).toBe("Agentic AI engineer");
  expect(profile.availability).toBe("Open to opportunities");
...
test("links the Nicholas wordmark back to the landing page", () => {
