...
The current album is curated from [`assets/photos/`](../../assets/photos/) and contains ten personal field frames. The source mix intentionally includes portrait and landscape compositions so the public gallery reads like an album rather than a uniform image grid.
